 ...
 *       &lt;/sequence>
 *       &lt;attribute name="nameType" use="required" type="{urn:oecd:ties:stf:v4}OECDNameType_EnumType" />
 *     &lt;/restriction>
 *   &lt;/complexContent>
 * &lt;/complexType>
 * </pre>
...
@XmlType(name = "NamePerson_Type", namespace = "urn:oecd:ties:crs:v1", propOrder = {
    "precedingTitle",
    "title",
    "firstName",
    "middleName",
