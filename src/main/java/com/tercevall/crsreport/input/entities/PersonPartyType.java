 ...
 *         &lt;element name="TIN" type="{urn:oecd:ties:commontypesfatcacrs:v1}TIN_Type" maxOccurs="unbounded" minOccurs="0"/>
 *         &lt;element name="Name" type="{urn:oecd:ties:crs:v1}NamePerson_Type" maxOccurs="unbounded"/>
 *         &lt;element name="Address" type="{urn:oecd:ties:commontypesfatcacrs:v1}Address_Type" maxOccurs="unbounded"/>
 *         &lt;element name="Nationality" type="{urn:oecd:ties:isocrstypes:v1}CountryCode_Type" maxOccurs="0" minOccurs="0"/>
...
@XmlType(name = "PersonParty_Type", namespace = "urn:oecd:ties:crs:v1", propOrder = {
    "resCountryCode",
    "tin",
    "name",
    "address",
...
public class PersonPartyType {
    ...
    public static class BirthInfo {
        ...
        @XmlElement(name = "BirthDate", namespace = "urn:oecd:ties:crs:v1", type = String.class)
        @XmlJavaTypeAdapter(Adapter2 .class)
        @XmlSchemaType(name = "date")
        protected Calendar birthDate;
        @XmlElement(name = "City", namespace = "urn:oecd:ties:crs:v1")
        protected String city;
        @XmlElement(name = "CitySubentity", namespace = "urn:oecd:ties:crs:v1")
        protected String citySubentity;
        @XmlElement(name = "CountryInfo", namespace = "urn:oecd:ties:crs:v1")
        ...
        public static class CountryInfo {
            ...
            @XmlElement(name = "CountryCode", namespace = "urn:oecd:ties:crs:v1")
            @XmlSchemaType(name = "string")
            protected CountryCodeType countryCode;
            @XmlElement(name = "FormerCountryName", namespace = "urn:oecd:ties:crs:v1")
