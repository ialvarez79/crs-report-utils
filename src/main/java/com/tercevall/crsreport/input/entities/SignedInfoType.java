...
public class SignedInfoType {
    ...
    protected List<ReferenceTypeXMLDSig> reference;
     ...
     * {@link ReferenceTypeXMLDSig }
     * 
     * 
     */
    public List<ReferenceTypeXMLDSig> getReference() {
        if (reference == null) {
            reference = new ArrayList<ReferenceTypeXMLDSig>();
        }
